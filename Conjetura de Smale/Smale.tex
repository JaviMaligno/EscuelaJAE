...
\QED
\end{dem}
\subsection{Partición de la unidad}\label{2.4}
...
\bibitem{Ha} Allen E. Hatcher, \emph{A proof of the Smale Conjecture $Diff(S^3)\simeq O(4)$}. Annals of Mathematics, 117 (1983) 553-607
\bibitem{Bo} François Laudenbach, \emph{Les 2-sphères de $\R^3$ vues par A. Hatcher et la conjecture de Smale $Diff(S^3)\sim O(4)$}. Séminaire Bourbaki, 1983-1984, exp nº629, p. 279-293. \url{http://www.numdam.org/item/?id=SB_1983-1984__26__279_0}
\bibitem{Se} Stephen A. Mitchell. \emph{Notes on Serre fibrations}. August 2001. \url{https://pdfs.semanticscholar.org/e737/a4f8b93242910c050c2faf761236dcf60f64.pdf}
\end{thebibliography}
